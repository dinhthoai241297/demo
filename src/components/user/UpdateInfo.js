...
class UpdateInfo extends Component {
    ...
    update = async e => {
        ...
        try {
            // let res = await this.props.update(name, city, password, nation, session);
            this.props.update(name, password, city, nation, session).then(res => {
                console.log(res);
            });
            console.log('res', res);
            return;
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        ...
        update: (name, password, city, nation, session) => dispatch(actions.updateApi(name, password, city, nation, session))
    }
}
